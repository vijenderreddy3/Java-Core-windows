...
import com.frostburg.StopandWaitClient;
import com.frostburg.StopandWaitServer;
...
public class FileTransfer {
	...
	public static void main(String[] args) {
		FileTransfer obj = new FileTransfer();
		...
		sendOrReceiveListner =	new java.awt.event.ActionListener() {
			...
			if(buttonClicked.equals("send")){
				...
				if(algorithm.equals("SAW")){
	        			try {
							StopandWaitClient stopandWaitClient = new StopandWaitClient(ip,port,pseudoNum,sendFilename);	        			
				...
				if(algorithm.equals("SAW")){
						...
						try {
							stopandWaitServer = new StopandWaitServer(port,receivedFileName);
